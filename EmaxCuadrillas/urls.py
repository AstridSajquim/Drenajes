"""EmaxCuadrillas URL Configuration
...
urlpatterns = [
    ...
    url(r'^principal/', include('principal.urls'), name='principal'),
    url(r'^casos/', include('casos.urls', namespace='casos')),
    url(r'^cuadrillas/', include('cuadrillas.urls', namespace='cuadrillas')),
